...
@Autonomous(name = "MOVE BLUE CLOSE", group = "Examples")
public class MOVE_Blue_Close extends WlooOpmode {
    ...
    private double HOMING_SERVO_UP;
    ...
    private final Pose end = new Pose(24, 96, Math.toRadians(360));  // shooting first row
