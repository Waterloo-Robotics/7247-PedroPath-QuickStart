...
public class Score_Red_Far extends WlooOpmode {
    ...
    private final Pose shoot1 = new Pose(87, 8, Math.toRadians(248));  // shooting preload
    private final Pose pickup1start = new Pose(109, 8, Math.toRadians(360));  // pick up 1st row start
